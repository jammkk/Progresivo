...
public int contador;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (this.jPasswordField1.getText().equals("23554350canela")) {
             CuentaDeCobro CDC;
     CDC= new CuentaDeCobro();
     
     CDC.show();
     this.hide();
            
        }else{
            JOptionPane.showMessageDialog(null, "La contraseña es invalida vuelve a intentarlo");
            if (contador>=3) {
                JOptionPane.showMessageDialog(null,"Se notificara al administrador del sistema via Mail el ingreso errado de la clave repetidamente,"
                        + "contactese con el administrador para recuperarla");
            }
